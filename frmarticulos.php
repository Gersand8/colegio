...
<?php
    ...
    $registros = "SELECT *FROM tb_articulo  WHERE Estado='Aceptado 1'";
        ...
        <table  class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class='btn btn-success' href='process/Acep.php?idarticulo=<?php echo $row['idarticulo'];?>' > Publicar </a>
                        <a class='btn btn-warning'href='process/Rejch.php?idarticulo=<?php echo $row['idarticulo'];?>'> Rechazar </a>
                    </td>
                </tr> 
                <?php } ?>    
            </tbody>
