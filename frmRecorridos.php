...
<body>
	<div class="container row ">
		...
		<div class="container">
			<form class="form-style-9" action="process/insertTravels.php" method="POST" enctype="multipart/form-data">
				<div class="container blue">
					<h2 class="blue-grey-text ">Registrar Nuevo lugar </h2> 
				...
				<ul>
                    ...
                    <li>
                        <input type="text" name="titulo" class="field-style field-full align-none" placeholder="Titulo" />
                    </li>
					<li>
					Foto: <input type="file" name="imagen" class="field-style field-full align-none" placeholder="Subject" />
					</li>
					<li>
						Descripcion del Lugar:<textarea name="descripcion" class="field-style" placeholder="Descripcion del problema"></textarea>
					</li>
					<li>
